...
protected:
   ...
   void reverseInorder(void visit(BinaryNode<ItemType>&), BinaryNode<ItemType>* subtreePtr) const;
   void reverseTree(BinaryNode<ItemType>* subtreePtr);
   ItemType findImmediateSuccessor(BinaryNode<ItemType>* subTreePtr, const ItemType target);
...
//   bool contains(const ItemType& anEntry) const;
   ...
   void reverseInorderTraverse(void visit(BinaryNode<ItemType>&)) const;
...
template<class ItemType>
void BinarySearchTree<ItemType>::reverseInorderTraverse(void visit(BinaryNode<ItemType>&)) const
{
	reverseInorder( visit, rootPtr );
}

template<class ItemType>
void BinarySearchTree<ItemType>::reverseInorder(void visit(BinaryNode<ItemType>&), BinaryNode<ItemType>* subtreePtr) const
{
...
template<class ItemType>
void BinarySearchTree<ItemType>::reverseTree(BinaryNode<ItemType>* subtreePtr)
{
	if ( subtreePtr == nullptr )
		return;
...
{
	return findImmediateSuccessor(rootPtr, target);
}

template<class ItemType>
ItemType BinarySearchTree<ItemType>::findImmediateSuccessor(BinaryNode<ItemType>* subtreePtr, const ItemType target)
{
